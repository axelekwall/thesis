...
By leveraging \textit{concept driven design research} \cite{stolterman_concept-driven_2010}, a survey was conducted and based on the results, an interactive prototype was developed and evaluated, in order to answer the research question.
...
The main findings are that a visualization tool, like the one proposed in this study, could be used to help developers and other stakeholders in software projects raise awareness about technical debt strategies and priorities.
